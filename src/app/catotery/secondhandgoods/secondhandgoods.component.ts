...
@Component({
  selector: 'app-secondhandgoods',
  templateUrl: './secondhandgoods.component.html',
  styleUrls: ['./secondhandgoods.component.css']
})
export class SecondhandgoodsComponent implements OnInit {
  category=[
    {
      id:1,
      text:'Hàng Cũ',
